 ...
 * @author admin
 */
@WebServlet(name="PostDetailsController", urlPatterns={"/view-blog"})
public class PostDetailsController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PostDetailsController</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PostDetailsController at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
      int blogId = Integer.parseInt(request.getParameter("blog_id"));
        ...
        if (blog != null) {
            ...
            request.getRequestDispatcher("/marketers/MKTPostDetails.jsp").forward(request, response);
        } else {
