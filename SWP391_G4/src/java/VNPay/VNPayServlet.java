...
//    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Lấy amount, bankCode, language từ form
        ...
        vnp_Params.put("vnp_Amount", String.valueOf(amount * 100)); // Nhân 100 vì VNPay tính đơn vị = 100 VND
        vnp_Params.put("vnp_CurrCode", "VND");
        if (bankCode != null && !bankCode.isEmpty()) {
            vnp_Params.put("vnp_BankCode", bankCode);
        }
        ...
        // Bước 1: Sắp xếp fieldNames
        List<String> fieldNames = new ArrayList<>(vnp_Params.keySet());
        Collections.sort(fieldNames);

        // Bước 2: Tạo URL query
        StringBuilder hashData = new StringBuilder();
        StringBuilder query = new StringBuilder();
        ...
        // *** Thay vì trả về JSON, ta redirect luôn:
