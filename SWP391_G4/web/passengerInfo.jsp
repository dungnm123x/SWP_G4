    ...
    <body class="container py-4 mt-5">
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                // Gắn sự kiện click cho nút Xóa vé
                rebindRemoveButtons();
            });
            ...
            function rebindRemoveButtons() {
                document.querySelectorAll(".btn-remove").forEach(btn => {
                    btn.addEventListener("click", function (e) {
                        ...
                        // Gửi AJAX (fetch) đến PassengerInfoServlet
                        fetch("passengerinfo?renderPartial=true", {
                            ...
                            body: params.toString()
                                ...
                                .then(resp => resp.text())
                                .then(html => {
                                    // Thay thế phần table cũ = table mới
                                    document.querySelector(".table-responsive").innerHTML = html;

                                    // Gắn lại event click cho nút Xóa (vì DOM thay đổi)
                                    rebindRemoveButtons();
                                })
